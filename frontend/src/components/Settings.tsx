export default function Settings({
  ...
  missingDefaultWarning, fetchPromptFiles, savePromptFile, promptData, handlePromptChange, saveServerConfig
}: any) {
  return (
    <div className="max-w-4xl mx-auto w-full animate-fade-in pb-12">
      ...
      {activeSettingsTab === 'LLM' && (
        <div className="bg-neutral-900 border border-neutral-800 rounded p-6 space-y-8 shadow-xl">
          ...
          <button onClick={saveServerConfig} className="bg-neutral-800 hover:bg-neutral-700 text-neutral-200 font-bold py-2 px-6 rounded border border-neutral-700 transition-colors shadow-lg">
